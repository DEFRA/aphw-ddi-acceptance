...
const enforcementEnvRoot = (process.env.ENFORCEMENT_TEST_ENVIRONMENT_ROOT_URL || 'http://host.docker.internal:3003')
...
exports.config = {
  ...
  port: 4444,
  path: '/wd/hub',
  specs: ['./features/aphw-ddi-portal/**/*.feature'],
  exclude: ['./scratch/**'],
  ...
  bail: 0,
  baseUrl: envRoot + '',
  enforcementBaseUrl: enforcementEnvRoot + '',
