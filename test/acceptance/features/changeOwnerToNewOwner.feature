Feature: Change owner(new owner new to the index)

        Scenario:  Creating a new dog and owner
                Given I open the url "/"
                When I click on the link containing "Process new CDO or"
                And I set "Grace" to the inputfield "#firstName"
                And I set "Lawton" to the inputfield "#lastName"
                And I set "01" to the inputfield "#dateOfBirth-day"
                And I set "05" to the inputfield "#dateOfBirth-month"
                And I set "1986" to the inputfield "#dateOfBirth-year"
                ...
                And I set "345671185691112" to the inputfield "#microchipNumber"
                And I click on the element "button=Continue"
                And I select the radio option with the value "XL Bully" from the radio group "breed"
                And I set "Mojo" to the inputfield "#name"
        ...
        Scenario: Process cdo  for a dog(submit microchip number that is on a dog of another owner)
                ...
                And I click on the element "button=Continue"
                And I set "ST7 2BS" to the inputfield "#postcode"
                And I set "9" to the inputfield "#houseNumber"
                And I click on the element "button=Continue"
                And I click on the element "button=Confirm address"
                And I set "345671185691112" to the inputfield "#microchipNumber"
                And I click on the element "button=Continue"
                Then I expect that element "h1" contains the text "Microchip number 345671185691112"
        ...
        Scenario: Select CDO and confirm all details
                ...
                And I expect that element "(//dd)[3]" contains the text "01 December 1988"
                And I expect that element "(//dd)[5]" contains the text "ST7 2BS"
                And I expect that element "(//dd)[7]" contains the text "England"
                And I expect that element "(//dd)[8]" contains the text "Cheshire Constabulary"
                And I expect that element "(//dd)[9]" contains the text "Lucy"
                ...
                And I expect that element "(//dd)[12]" contains the text "Mojo"
                And I expect that element "(//dd)[13]" contains the text "345671185691112"
                And I expect that element "(//dd)[14]" contains the text "29 May 2024"
                And I expect that element "(//dd)[15]" contains the text "29 July 2024"
                And I expect that element "(//dd)[16]" contains the text "ED3"

        Scenario: New application created successfully for new owner and existing dog
                When I click on the element "button=Confirm details"
                Then I expect that element "h1" contains the text "Record created" 
                And I expect that element "(//dd)[1]" contains the text "XL Bully"
                And I expect that element "(//dd)[2]" contains the text "Mojo"
                And I expect that element "(//dd)[3]" contains the text "345671185691112"
                ...
                And I expect that element "(//dd)[10]" contains the text "Northampton (Northampton Crown Court)"  
                And I expect that element "(//dd)[11]" contains the text "Cheshire Constabulary"  
                And I expect that element "(//dd)[12]" contains the text "Lucy" 


        Scenario: Verify dog is moved to new owner and exemption details updated successfully
                Given I open the url "/"
                When I click on the link "Search dog index"
                And I set "Mojo" to the inputfield "#searchTerms"
                And I press "Enter"
                ...
                And I click on the link "Dog record"
                Then I expect that element "h1" contains the text "Dog ED30"
                And I expect that element "(//dd)[1]" contains the text "Mojo"
                ...
                And I expect that element "(//dd)[6]" contains the text "345671185691112"
