Feature: Send application pack by email
...
Scenario:  Creating a new dog and owner
        ...
        And I set "Aspin" to the inputfield "#lastName"
        ...
        And I set "Breeze" to the inputfield "#name"
    ...
    Scenario: Search dog and navigate to manage cdo application
        ...
        And I set "Breeze" to the inputfield "#searchTerms"
        And I press "Enter"
    ...
    Scenario: Send application pack by email
        ...
        And I set "thomas_aspin@testmail.com" to the inputfield "//input[@name='email']"
    ...
    Scenario: Verify history for dog
        ...
        Then I expect that element "tbody" contains the text "Application pack sent to thomas_aspin@testmail.com"
        And I expect that element "tbody" contains the text "Email address updated"

    Scenario: Verify email is added to owner Record
    	Given I open the url "/"
        And I click on the link "Search dog index"
        And I set "Breeze" to the inputfield "#searchTerms"
        And I press "Enter"
        ...
        Then I expect that element "h1" contains the text "Thomas Aspin"
        And I expect that element "(//dd)[5]" contains the text "thomas_aspin@testmail.com"          