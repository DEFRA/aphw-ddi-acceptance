Feature: Reuse existing owner and dog for new application
   ...
   Scenario: Verify dog exemption details updated successfully
      ...
      And I expect that element "(//dd)[14]" contains the text "Interim exempt"
      And I expect that element "(//dd)[16]" contains the text "Not entered"
      And I expect that element "(//dd)[17]" contains the text "Not entered"
      And I expect that element "(//dd)[18]" contains the text "Not entered"
      And I expect that element "(//dd)[19]" contains the text "West Yorkshire Police" 
      And I expect that element "(//dd)[20]" contains the text "Andrew" 
