Feature: Reuse existing owner and dog for new application
   ...
   Scenario: Select Interim exemption scheme and confirm all details
      ...
      And I expect that element "(//dd)[6]" contains the text "Andrew"
      And I expect that element "(//dd)[7]" not contains any text
      ...
      And I expect that element "(//dd)[12]" contains the text "ED3"
