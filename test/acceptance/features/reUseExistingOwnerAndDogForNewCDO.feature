Feature: Reuse existing owner and dog for new application
   ...
   Scenario: Select CDO and confirm all details
      ...
      And I expect that element "(//dd)[2]" not contains any text
      And I expect that element "(//dd)[3]" contains the text "LS20 8DA"
      And I expect that element "(//dd)[4]" contains the text "England"
      And I expect that element "(//dd)[5]" contains the text "West Yorkshire Police"
      And I expect that element "(//dd)[6]" contains the text "James"
      ...
      And I expect that element "(//dd)[9]" contains the text "Fido"
      And I expect that element "(//dd)[10]" contains the text "345677654312333"
      And I expect that element "(//dd)[11]" contains the text "01 February 2024"
      And I expect that element "(//dd)[12]" contains the text "01 April 2024"
   ...
   Scenario: New application created successfully for existing owner and existing dog
      ...
      And I expect that element "(//dd)[10]" contains the text "James"
      And I expect that element "(//dd)[11]" contains the text "Northampton (Northampton Crown Court)"   
   ...
   Scenario: Verify dog exemption details updated successfully
      ...
      And I expect that element "(//dd)[19]" contains the text "01 April 2024"
      ...
      And I expect that element "(//dd)[22]" contains the text "West Yorkshire Police" 
      And I expect that element "(//dd)[23]" contains the text "James" 
