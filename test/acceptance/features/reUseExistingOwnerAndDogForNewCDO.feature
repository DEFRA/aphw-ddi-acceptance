Feature: Reuse existing owner and dog for new application
   ...
   Scenario: Verify dog exemption details updated successfully
      ...
      And I expect that element "(//dd)[10]" contains the text "01 February 2024"
      And I expect that element "(//dd)[11]" contains the text "01 April 2024"
      And I expect that element "(//dd)[12]" contains the text "Northampton (Northampton Crown Court)"              
      And I expect that element "(//dd)[13]" contains the text "West Yorkshire Police" 
      And I expect that element "(//dd)[14]" contains the text "James" 
