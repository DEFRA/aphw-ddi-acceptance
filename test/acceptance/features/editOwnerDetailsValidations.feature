Feature: Edit owner details
    ...
    Scenario: Missing mandatory fields
        ...
        And I expect that element "form" contains the text "Enter first line of address"
    ...
    Scenario: Invalid owner date of Birth format(day missing)
        ...
        And I click on the element "button=Save details"
        Then I expect that element "form" contains the text "Date of birth must include a day"
    ...
    Scenario: Invalid postcode
        ...
        And I click on the element "button=Save details"
        Then I expect that element "form" contains the text "Postcode must be a real postcode"
    ...
    Scenario: Invalid email address format(no domain)
        ...
        And I click on the element "button=Save details"
        Then I expect that element "form" contains the text "Email address must be real"
    ...
    Scenario: Invalid Telephone number
       ...
       And I click on the element "button=Save details"
       Then I expect that element "form" contains the text "Telephone number must be real"
