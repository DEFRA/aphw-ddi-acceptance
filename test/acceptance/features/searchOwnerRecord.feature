Feature: Perform a basic search
    ...
    Scenario: Search owner record with town/city name
        ...
        And I expect that element "(//ul)[1]" contains the text "Flat 7, 23, Northampton, NN11 7DF"
        And I expect that element "(//td)[2]" contains the text "Lola"
        And I expect that element "(//td)[3]" contains the text "Applying for exemption"
        And I expect that element "(//td)[5]" contains the text "Luna"
        And I expect that element "(//td)[6]" contains the text "Applying for exemption"
        And I expect that element "(//ul)[2]" contains the text "42 Scholars Court, Northampton, NN1 1ES"
        And I expect that element "(//td)[8]" contains the text "Bob"
        And I expect that element "(//td)[9]" contains the text "Applying for exemption"
        And I expect that element "(//ul)[3]" contains the text "60 Scholars Court, Northampton, NN1 1ES"
        And I expect that element "(//td)[11]" contains the text "Dino"
        And I expect that element "(//td)[12]" contains the text "Interim exempt"
        And I expect that element "(//td)[14]" contains the text "Maxie"
        And I expect that element "(//td)[15]" contains the text "Interim exempt"
