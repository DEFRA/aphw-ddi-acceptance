Feature: Edit exemption details
    ...
    Scenario: Exemption details updated successfully
        ...
        And I expect that element "(//dd)[20]" contains the text "01 February 2024"
        And I expect that element "(//dd)[21]" contains the text "01 April 2024"
        ...
        And I expect that element "(//dd)[25]" contains the text "10 March 2024"
        And I expect that element "(//dd)[26]" contains the text "Dogs Trust"
        And I expect that element "(//dd)[27]" contains the text "10 March 2026"
        And I expect that element "(//dd)[28]" contains the text "10 March 2023"
        And I expect that element "(//dd)[29]" contains the text "11 March 2023"
