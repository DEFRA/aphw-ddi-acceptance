Feature: Edit dog details
    ...
    Scenario: Enter microchip number already exists in the database for another dog
        ...
        And I expect that element "form" contains the text "The microchip number already exists"    
