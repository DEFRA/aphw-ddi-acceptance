Feature: Edit exemption details
    ...
    Scenario: Invalid dates in Removed from CDO process
        ...
        And I click on the element "button=Save details"
        Then I expect that element "form" contains the text "Year must include four numbers"
    ...
    Scenario: Missing month in Insurance renewal date
        ...
        And I click on the element "button=Save details"
        Then I expect that element "form" contains the text "Enter a renewal date"
    ...
    Scenario: Validations for mandatory fields for pre-exempt/exempt dog
        ...
        And I expect that element "form" contains the text "Enter an issue date" 
        And I expect that element "form" contains the text "Enter an expiry date"
    ...
    Scenario: Verify court and cdo dates not mandatory for interim-exempt dog
        ...
        And I click on the element "button=Save details"
        Then I expect that element "form" contains the text "Select a police force" 
        And I expect that element "form" not contains the text "Enter an issue date" 
        And I expect that element "form" not contains the text "Enter an expiry date"
